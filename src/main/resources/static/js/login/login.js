...
kakaoLoginBtn.addEventListener("click", (e) =>{
    location.href = "https://kauth.kakao.com/oauth/authorize?client_id=9ffffff5782a2590a40ff8f0f6d03bda&redirect_uri=http://43.201.110.15/kakao/login&response_type=code";
});
